...
class LoginForm(FlaskForm):
    ...
    password = PasswordField("Password", [validators.Length(min=4), validators.data_required()])
...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField("Password", [validators.Length(min=4, message=("Password must be between 4 and 100 characters long.")), validators.DataRequired()])
